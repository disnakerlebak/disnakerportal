<div class="max-w-6xl mx-auto h-full min-h-0 flex flex-col px-6 py-8 gap-6 box-border">
    ...
    <form wire:submit.prevent="applyFilters" @keydown.enter.prevent="$wire.applyFilters()" class="flex flex-wrap items-center gap-3">
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->hasActiveFilters): ?>
    ...
    <div class="flex flex-wrap items-center gap-2 text-sm font-medium">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $typeTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button"
                    wire:click="setType('<?php echo e($value); ?>')"
                    class="px-4 py-2 rounded-full border transition <?php echo e($type === $value ? 'bg-indigo-600 border-indigo-500 text-white shadow' : 'border-slate-700 text-slate-300 hover:bg-slate-800'); ?>">
                <?php echo e($label); ?>
            ...
            <div class="overflow-x-auto h-full min-h-0 pb-10">
                <div class="h-full min-h-0 overflow-visible">
                    <table class="min-w-full w-full text-sm text-slate-200">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $apps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <tr class="transition hover:bg-gray-800/60" wire:key="ak1-row-<?php echo e($app->id); ?>">
                                
                                <td class="p-3 align-top">
                                    <div class="font-semibold text-white"><?php echo e($app->user->name); ?></div>
                                    <div class="text-xs text-gray-400"><?php echo e($app->user->email); ?></div>
                                ...
                                <td class="p-3 align-top text-center whitespace-nowrap">
                                    <div><?php echo e($app->created_at->format('d M Y')); ?></div>
                                    <div class="text-xs text-gray-400"><?php echo e($app->created_at->diffForHumans()); ?></div>
                                </td>

                                
                                <td class="p-3 align-top text-center">
                                    <span class="inline-flex px-3 py-1 rounded-full text-xs font-semibold <?php echo e($badgeClass); ?>">
                                ...
                                <td class="p-3 align-top text-center whitespace-nowrap">
                                    <span class="inline-flex items-center gap-2">
                                        <span class="h-2 w-2 rounded-full
                                            <?php echo e($app->type === 'perpanjangan' ? 'bg-amber-400' : ($app->type === 'perbaikan' ? 'bg-yellow-400' : 'bg-indigo-400')); ?>">
                                        </span>
                                ...
                                <td class="p-3 align-middle text-left text-sm">
                                    ...
                                    ?>
                                    <!--[if BLOCK]><![endif]--><?php if(in_array($app->status, ['Ditolak','Revisi Diminta','Batal'])): ?>
                                        <!--[if BLOCK]><![endif]--><?php if($hasNote): ?>
                                            <div x-data="{ open:false }" class="<?php echo e($noteColor); ?> max-w-[38ch]">
                                ...
                                <td class="p-3 align-top text-center whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($app->nomor_ak1): ?>
                                        <div class="flex flex-col items-center gap-1">
                                            <span><?php echo e($app->nomor_ak1); ?></span>
                                            <!--[if BLOCK]><![endif]--><?php if($app->is_active): ?>
                                ...
                                <td class="p-3 align-top whitespace-nowrap">
                                    <!--[if BLOCK]><![endif]--><?php if($app->lastHandler?->actor?->name): ?>
                                        <div class="font-medium"><?php echo e($app->lastHandler->actor->name); ?></div>
                                        <div class="text-xs text-gray-400">
                                            <?php echo e(ucfirst(str_replace('_',' ',$app->lastHandler->action))); ?>

                                            · <?php echo e($app->lastHandler->created_at?->format('d M Y H:i')); ?>
                                    ...
                                    <div class="flex items-center justify-center">
                                        <div class="relative" x-data="dropdownMenu()" x-id="['action-menu']">
                                            ...
                                            <template x-teleport="body">
                                                ...
                                                <button onclick="showDetail(<?php echo e($app->id); ?>)"
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(in_array($app->status, ['Menunggu Verifikasi', 'Menunggu Revisi Verifikasi'])): ?>
                                                    <button
                                                        type="button"
                                                        onclick="openApproveModal(this)"
                                                        data-approve-url="<?php echo e(route('admin.ak1.approve', $app)); ?>"
                                                        data-app-name="<?php echo e($app->user->name); ?>"
                                                        data-app-email="<?php echo e($app->user->email); ?>"
                                                    ...
                                                    <button onclick="openRejectModal(<?php echo e($app->id); ?>)"
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($app->status === 'Disetujui' && $app->is_active): ?>
                                                    <button
                                                        type="button"
                                                        onclick="openUnapproveModal(this)"
                                                        data-unapprove-url="<?php echo e(route('admin.ak1.unapprove', $app)); ?>"
                                                        data-app-name="<?php echo e($app->user->name); ?>"
                                                        data-app-email="<?php echo e($app->user->email); ?>"
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($app->status === 'Disetujui' && $app->nomor_ak1 && $app->is_active): ?>
                                                    <a href="<?php echo e(route('admin.ak1.cetak', $app->id)); ?>" target="_blank"
                                                ...
                                                <button
                                                    ...
                                                    data-app-name="<?php echo e($app->user->name); ?>"
                                                    data-app-email="<?php echo e($app->user->email); ?>"
                                                    data-current-status="<?php echo e($app->status); ?>"
                                                    data-logs='<?php echo json_encode($logPayload, 15, 512) ?>'>
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'detail-ak1','show' => false,'maxWidth' => '6xl','animation' => 'zoom']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'detail-ak1','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '6xl','animation' => 'zoom']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'reject-ak1','show' => false,'maxWidth' => 'md','animation' => 'slide-up']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'reject-ak1','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md','animation' => 'slide-up']); ?>
        ...
        <form id="rejectForm" method="POST" class="px-6 py-5">
            ...
            <div class="mb-3">
                ...
                <select name="reason_id" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-2 py-1.5 text-gray-200">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rejectionReasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'log-ak1','show' => false,'maxWidth' => '3xl','animation' => 'zoom']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'log-ak1','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => '3xl','animation' => 'zoom']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'unapprove-ak1','show' => false,'maxWidth' => 'lg','animation' => 'slide-up']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'unapprove-ak1','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'lg','animation' => 'slide-up']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'approve-ak1','show' => false,'maxWidth' => 'md','animation' => 'slide-up']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'approve-ak1','show' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'maxWidth' => 'md','animation' => 'slide-up']); ?>
        <div class="flex items-center justify-between border-b border-slate-800 px-6 py-4">
            <div>
...
<?php if (! $__env->hasRenderedOnce('7425a266-f0ce-4526-a4bd-3fa31013b364')): $__env->markAsRenderedOnce('7425a266-f0ce-4526-a4bd-3fa31013b364'); ?>
...
<?php /**PATH C:\xampp\htdocs\disnakerportal\resources\views/livewire/admin/ak1-table.blade.php ENDPATH**/ ?>