    ...
    <div class="max-w-6xl mx-auto py-8 px-4">
        ...
        <div class="rounded-xl border border-dashed border-blue-300/40 bg-blue-50/50 px-6 py-5 text-blue-900 shadow-sm dark:border-blue-400/30 dark:bg-blue-500/10 dark:text-blue-100">
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <a href="<?php echo e(route('pencaker.profile')); ?>"
...
<?php echo $__env->make('layouts.pencaker', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\disnakerportal\resources\views/pencaker/dashboard.blade.php ENDPATH**/ ?>