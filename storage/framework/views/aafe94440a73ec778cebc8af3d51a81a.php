...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> | Admin Disnaker</title>
    <script>
...
>
  ...
  <nav class="p-3 flex-1 overflow-y-auto" x-bind:class="sidebarCollapsed ? 'space-y-0.5' : 'space-y-1'">
    ...
    <a href="<?php echo e(route('admin.dashboard')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6"/>
      </svg>
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Dashboard</span>
    ...
    <!-- Verifikasi AK1 -->
    <a href="<?php echo e(route('admin.ak1.index')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.ak1.*') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"/>
      </svg>
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Verifikasi AK1</span>
    ...
    <a href="<?php echo e(route('admin.pencaker.index')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.pencaker.*') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
      </svg>
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Data Pencaker</span>
      <span class="tooltip-text" x-show="sidebarCollapsed">Data Pencaker</span>
    </a>

    <!-- Alasan Penolakan -->
    <a href="<?php echo e(route('admin.rejection-reasons.index')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.rejection-reasons.*') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636"/>
      </svg>
            <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Alasan Penolakan</span>
    ...
    <a href="<?php echo e(route('admin.manage.index')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.manage.index') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Kelola Admin</span>
      <span class="tooltip-text" x-show="sidebarCollapsed">Kelola Admin</span>
    </a>

    <!-- Kelola Pencaker (Superadmin only) -->
    <a href="<?php echo e(route('admin.manage.pencaker')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.manage.pencaker') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Kelola Pencaker</span>
...
<?php endif; ?>
    ...
    <a href="#"
       class="<?php echo e($linkBase); ?> text-slate-400 opacity-60 cursor-not-allowed tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21h7.5V10.75M2.25 21h1.5m18 0h-18M2.25 9l4.5-1.636M18.75 3l-1.5.545m0 6.205 3 1m1.5.5-1.5-.5M6.75 7.364V3h-3v18m3-13.636 10.5-3.819"/>
      </svg>
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Verifikasi Perusahaan</span>
    ...
    <a href="#"
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Pengumuman</span>
    ...
    <a href="#"
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Log Aktivitas</span>
    ...
    <a href="<?php echo e(route('profile.edit')); ?>"
       class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('profile.edit') ? 'bg-indigo-600 text-white shadow' : 'text-slate-300'); ?> tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="<?php echo e($iconBase); ?>" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Pengaturan</span>
      <span class="tooltip-text" x-show="sidebarCollapsed">Pengaturan</span>
    </a>
  </nav>

  <!-- Logout -->
  <form method="POST" action="<?php echo e(route('logout')); ?>" class="p-3 border-t border-slate-800">
    <?php echo csrf_field(); ?>
    <button type="submit" class="group w-full <?php echo e($linkBase); ?> bg-red-700/20 text-red-400 hover:bg-red-600/30">
      ...
      <span x-cloak x-show="!sidebarCollapsed" class="<?php echo e($labelBase); ?>">Logout</span>
    </button>
  </form>
</aside>
    ...
    <div class="flex-1 min-w-0 flex flex-col transition-all duration-200 bg-slate-950 border-l border-slate-800"
        ...
        <header class="flex justify-between items-center px-4 py-4 border-b border-slate-800 bg-slate-900/60 backdrop-blur">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="font-semibold text-lg"><?php echo $__env->yieldContent('title'); ?></h1>
            </div>
            <div class="flex items-center space-x-4">
                ...
                <div class="text-sm text-slate-300"><?php echo e(Auth::user()->name ?? 'Super Admin Disnaker'); ?></div>
            </div>
        </header>
...
<?php /**PATH C:\xampp\htdocs\disnakerportal\resources\views/layouts/admin.blade.php ENDPATH**/ ?>